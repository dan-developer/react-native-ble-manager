...
public class DanPeripheral extends Peripheral {

    private ScanRecord advertisingData;
    private ScanResult scanResult;

    public DanPeripheral(ReactContext reactContext, ScanResult result) {
    ...
    public DanPeripheral(BluetoothDevice device, ReactApplicationContext reactContext) {
